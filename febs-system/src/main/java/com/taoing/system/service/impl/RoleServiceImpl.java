...
import com.taoing.system.dao.RoleMapper;
import com.taoing.system.dao.RoleMenuMapper;
...
import com.taoing.system.service.RoleService;
...
public class RoleServiceImpl extends BaseService<Role> implements RoleService {
    ...
    public Role findByName(String roleName) {
        Example example = new Example(Role.class);
        example.createCriteria().andCondition("lower(role_name)=",
