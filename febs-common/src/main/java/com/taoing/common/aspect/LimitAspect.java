package com.taoing.common.aspect;

import com.google.common.collect.ImmutableList;
import com.taoing.common.annotation.Limit;
import com.taoing.common.domain.LimitType;
...
public class LimitAspect {
    ...
    // 声明一个切点
    @Pointcut("@annotation(com.taoing.common.annotation.Limit)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        ImmutableList<String> keys = ImmutableList.of(StringUtils.join(
                limitAnnotation.prefix() + "_", key + "_" + request.getRequestedSessionId()));
