...
/**
 * Apache POI SXSS相关api的简易封装, 操作excel文档
 */
public class POIUtils {
    ...
    static SXSSFWorkbook newSXSSFWorkbook() {
        return new SXSSFWorkbook(MDEFAULTROWACCESSWINDOWSIZE);
    }
    ...
    static void writeByLocalOrBrowser(HttpServletResponse response, String fileName,
        ...
        try {
            ...
            if (response != null) {
                ...
                response.setHeader("Content-disposition", "attachment; filename=" +
                        URLEncoder.encode(String.format("%s%s", fileName, FebsConstant.XLSX_SUFFIX),
                                "UTF-8"));
                if (out == null) {
