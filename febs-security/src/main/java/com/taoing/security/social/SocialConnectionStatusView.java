...
public class SocialConnectionStatusView extends AbstractView {
    ...
    protected void renderMergedOutputModel(@Nullable Map<String, Object> map, @Nullable HttpServletRequest request,
        ...
        Objects.requireNonNull(response).setContentType(FebsConstant.JSON_UTF8);
