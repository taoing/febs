package com.taoing.web.common.thymeleaf.dict;
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
        ...
        for (Dict dict : dicts) {
            if (valueAttr != null && realvalue.equals(dict.getKeyy()))
                ...
                selected = "";
            options.append("<options value=\"").append(dict.getKeyy()).append("\"")
                    .append(selected).append(">").append(dict.getValuee()).append("</option>");
        }
