...
import com.taoing.web.domain.UserOnLine;
...
public class SessionController {
    ...
    public void sessionInvalid(HttpServletRequest request, HttpServletResponse response,
            ...
            for (Object o : principals) {
                ...
                informations.forEach(information -> {
                    ...
                    if (principal instanceof FebsUserDetails) {
                        FebsUserDetails details = (FebsUserDetails) principal;
                    ...
                    if (principal instanceof FebsSocialUserDetails) {
                        FebsSocialUserDetails details = (FebsSocialUserDetails) principal;
                        userOnLine.setUsername(details.getUsername());
                        userOnLine.setIp(details.getRemoteAddress());
                        userOnLine.setLocation(AddressUtils.getCityInfo(userOnLine.getIp()));
                        userOnLine.setLoginTime(details.getLoginTime());
                    ...
                    LocalDateTime lastRequestLocalDateTime = LocalDateTime.ofInstant(lastRequest.toInstant(),
                            ZoneId.systemDefault());
                    // 通过时间判断session是否已过期, 没过期则添加到在线人员集合中
