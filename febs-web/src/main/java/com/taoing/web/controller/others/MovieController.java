...
public class MovieController {
    ...
    public ResponseBo getMovieHot() {
        try {
            String data = HttpUtils.sendSSLPost(FebsConstant.TIME_MOVIE_HOT_URL,
                    "locationId=328");
    ...
    public ResponseBo getMovieComing() {
        try {
            String data = HttpUtils.sendSSLPost(FebsConstant.TIME_MOVIE_COMING_URL,
                    "locationId=328");
            return ResponseBo.ok(data);
        } catch (Exception e) {
    ...
    public ResponseBo getDetail(String id) {
        try {
            String data = HttpUtils.sendSSLPost(FebsConstant.TIME_MOVIE_DETAIL_URL,
                    "locationId=328&movieId=" + id);
            return ResponseBo.ok(data);
        } catch (Exception e) {
    ...
    public ResponseBo getComments(String id) {
        try {
            String data = HttpUtils.sendSSLPost(FebsConstant.TIME_MOVIE_COMMENTS_URL,
                    "movieId=" + id);
            return ResponseBo.ok(data);
        } catch (Exception e) {
