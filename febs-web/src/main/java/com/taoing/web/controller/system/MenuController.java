...
public class MenuController extends BaseController {
    ...
    public ResponseBo getMenu(String userName) {
        try {
            ...
            return ResponseBo.error("获取菜单失败, 请联系网站管理员!");
        }
    }
    ...
    public ResponseBo getMenu(Long menuId) {
        try {
            ...
            return ResponseBo.error("获取菜单信息失败, 请联系网站管理员!");
        }
    }
    ...
    public ResponseBo getMenuButtonTree() {
        try {
            ...
            return ResponseBo.error("获取菜单列表失败, 请联系网站管理员!");
        }
    }
    ...
    public ResponseBo getMenuTree() {
        try {
            ...
            return ResponseBo.error("获取菜单树失败, 请联系网站管理员!");
        }
    }
    ...
    public ResponseBo getUserMenu(String userName) {
        try {
            ...
            return ResponseBo.error("获取用户菜单失败, 请联系网站管理员!");
        }
    }
    ...
    public ResponseBo deleteMenus(String ids) {
        try {
            ...
            return ResponseBo.error("删除菜单失败, 请联系网站管理员!");
        }
    }
